                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ Number(product.commission_percent).toFixed(2) }}</td>
                                    <td>{{ Number(product.SaleDetails_TotalAmount * (product.commission_percent / 100)).toFixed(2) }}</td>
    ...
    computed: {
        totalCommissionAmount() {
            ...
            this.cart.forEach(product => {
                if (product.SaleDetails_TotalAmount && product.commission_percent) {
                    let amount = product.SaleDetails_TotalAmount * (product.commission_percent / 100);
                    totalAmount += amount;
                }
            });
