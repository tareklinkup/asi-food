        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="hrPayroll">
                    ...
                    <li><input type="checkbox" class="access" value="salarypayment" v-model="access"> Salary Payment (old)</li>
                    ...
                    <li><input type="checkbox" class="access" value="employeesalaryreport" v-model="access"> Salary Payment Report (old)</li>
                </ul>
            </div>
            <div class="group">
                ...
                <ul ref="production">
                    ...
                    <li><input type="checkbox" class="access" value="material_category" v-model="access"> Material Category</li>
                </ul>
            </div>
            <div class="group">
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <!-- <li><input type="checkbox" class="access" value="asset-category" v-model="access"> Asset Categories</li> -->
