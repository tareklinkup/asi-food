...
<div id="balanceSheet">
	...
	<div style="display:none;" v-bind:style="{display: showReport ? '' : 'none'}">
		...
		<div id="printContent">
			<div class="row" style="margin-top:15px;">
				<div class="col-xs-6">
					<table id="headerTable" class="balancesheet-table">
						<thead>
							<tr>
								<td colspan="2">
									<h3>Asset</h3>
				...
				<div class="col-xs-6">
					<table id="headerTable2" class="balancesheet-table">
						<thead>
							<tr>
								<td colspan="2">
									<h3>Liability</h3>
...
<script type="text/javascript">
	function fnExcelReport()
	{
	    ...
	    {     
			if(tab2.rows.length > j ){
				tab_text = tab_text + tab.rows[j].innerHTML + tab2.rows[j].innerHTML + "</tr>";
			}else{
