        ...
        <div class="row" style="padding-top:10px;">
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: loanReceives.length > 0 ? '' : 'none'}">{{ totalInitialLoan | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered table-condensed">
                    <thead>
                        <tr style="background: #dee4dc;">
                            <th colspan="5">Employee Payments (old)</th>
                        </tr>
                        <tr>
                            <th>Employee Id</th>
                            <th>Employee Name</th>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: employeeNewPayments.length > 0 ? '' : 'none'}">
                        <template v-for="payment in employeeNewPayments">
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            <td colspan="4" style="text-align:right">Total</td>
                            <td style="text-align:right;">
                                <span v-if="employeeNewPayments.length == 0">0.00</span>
                                <span style="display:none;"
                                    v-bind:style="{display: employeeNewPayments.length > 0 ? '' : 'none'}">{{ totalEmployeeNewPayments | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
...
new Vue({
    ...
    computed: {
        ...
        totalEmployeeNewPayments() {
            return this.employeeNewPayments.reduce((prev, curr) => {
        ...
        totalCashOut() {
            return parseFloat(this.totalPurchase) +
                ...
                parseFloat(this.totalEmployeeNewPayments);
        },
        cashBalance() {
    ...
    methods: {
        ...
        getEmployeeNewPayments() {
            ...
            axios.post('/get_payments', filter)
                .then(res => {
                    this.employeeNewPayments = res.data;
                })
        },
