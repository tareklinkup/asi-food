            ...
            <form id="materialForm" class="form-horizontal" v-on:submit.prevent="saveMaterial">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                            <v-select label="name" v-bind:options="materialCategories"
                                v-model="selectedMaterialCategory" placeholder="Select Category"></v-select>
                        </div>
                        <div class="col-sm-1" style="padding: 0;">
                            <a href="/material-category" title="Add New Category" class="btn btn-xs btn-danger"
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            saveMaterial() {
                if(this.selectedMaterialCategory == null){
                ...
                this.material.category_id = this.selectedMaterialCategory.id;
            ...
            editMaterial(material){
                ...
                this.selectedMaterialCategory = { id: material.category_id, name: material.category_name };
