...
<ul class="nav nav-list">
    ...
    <li class="">
        ...
        <ul class="submenu">
            ...
            <!-- <?php if (array_search("area", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<li class="">
						<a href="<?php echo base_url(); ?>asset-category">
							<i class="menu-icon fa fa-caret-right"></i>
...
<ul class="nav nav-list">
    ...
    <li class="">
        <a href="<?php echo base_url(); ?>material-category">
            <i class="menu-icon fa fa-th-list"></i>
...
<ul class="nav nav-list">
    ...
    <li class="">
        <a href="<?php echo base_url(); ?>customerPaymentPage">
            ...
            <span class="menu-text"> Customer Due Collec</span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
...
<ul class="nav nav-list">
    ...
    <li class="">
        <a href="<?php echo base_url(); ?>salarypayment">
            <i class="menu-icon fa fa-money"></i>
            <span class="menu-text"> Salary Payment (old) </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
