                ...
                <table id="headerTable" class="record-table"
                    ...
                    <tbody>
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:center;">
                                {{ sales.reduce((prev,curr) => {return prev + parseFloat(curr.saleDetails.reduce((p,c) => {return +p + +c.SaleDetails_TotalQuantity}, 0))}, 0) }}
                            </td>
                ...
                <table id="headerTable" class="record-table"
                    ...
                    <tbody>
                        <tr v-for="sale in sales">
                            ...
                            <td style="text-align:right;">{{ Number(sale.total_commission_amount).toFixed(2) }}</td>
                            <td style="text-align:center;">
                                <a href="" title="Sale Invoice"
                                    v-bind:href="`/sale_invoice_print/${sale.SaleMaster_SlNo}`" target="_blank"><i
                                        class="fa fa-file"></i></a>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                {{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.total_commission_amount)}, 0) }}
                            </td>
                            <td></td>
                        </tr>
                    </tfoot>
                    ...
                    <table id="headerTable" class="record-table" v-if="selectedProduct != null">
                        ...
                        <tfoot>
                            <tr style="font-weight:bold;">
                                <td colspan="5" style="text-align:right;">Total</td>
                                <td style="text-align:right;">
                                    {{ sales.reduce((prev, curr) => { return prev + parseFloat(curr.SaleDetails_Rate)}, 0) }}
                                </td>
                                <td style="text-align:right;">
