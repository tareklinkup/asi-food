                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <v-select v-bind:options="categories" v-model="selectedCategory"
                                            label="ProductCategory_Name" placeholder="Select Category"></v-select>
                                    </div>
                                    <div class="col-sm-1" style="padding: 0;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 no-padding-right" style="display: flex">
                                        <input type="number" id="commission" step="0.01"
                                            v-model.number="selectedProduct.commission_percent"
                                            v-on:input="commissionTotal" class="form-control" />
                                        <span style="display: inline-block; margin-left: 4px; font-size: 15px">%</span>
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" v-model="commission" step="0.01"
                                            v-on:input="commissionTotal" class="form-control" />
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                    ...
                                    <tr style="display:none;"
                                        v-bind:style="{display: sales.payment_type == 'bank' ? '' : 'none'}">
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label no-padding-right">Bank
                                                    Account</label>
                                                <div class="col-sm-12">
                                                    <v-select v-bind:options="filteredAccounts"
                                                        v-model="selectedAccount" label="display_text"
    ...
    methods: {
        ...
        commissionTotal() {
            if (event.target.id == 'commission') {
                this.commission = ((parseFloat(this.selectedProduct.total) * parseFloat(this.selectedProduct
                    .commission_percent)) / 100).toFixed(2);
            } else {
                this.selectedProduct.commission_percent = (parseFloat(this.commission) / parseFloat(this
                    .selectedProduct.total) * 100).toFixed(2);
            }
        },
        productTotal() {
