...
class Model_Table extends CI_Model{
    ...
    public function getTransactionSummary($date = null){
        $transactionSummary = $this->db->query("
            ...
            (
                select ifnull(sum(ep.total_payment_amount), 0) from tbl_employee_payment_new ep
            ...
            (
                select paid_purchase + paid_customer + paid_supplier + paid_cash + bank_deposit + employee_payment + employee_payment_old + loan_payment + invest_payment + buy_asset + paid_material_purchase
            ) as total_out,
            (
