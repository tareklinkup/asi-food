...
class Reports extends CI_Controller {
    ...
    public function materialList()
	{
        ...
        $data['materials'] = $this->db->query("
            ...
            join tbl_material_categories mc on mc.id = m.category_id
        ...
        try {
            ...
            $other_income_expense = $this->db->query("
                ...
                (
                    ...
                    from tbl_employee_payment_new ep
            ...
            $net_profit = ($profits + $total_transport_cost + $other_income_expense->income + $total_vat) - ($total_discount + $other_income_expense->returned_amount + $other_income_expense->damaged_amount + $other_income_expense->material_damaged_amount + $other_income_expense->expense + $other_income_expense->employee_payment + $other_income_expense->employee_payment_old + $other_income_expense->profit_distribute + $other_income_expense->loan_interest + $other_income_expense->assets_sales_profit_loss );
