    ...
    public function addSales(){
        ...
        try{
            ...
            if($data->sales->account_id){
                ...
                $this->db->insert('tbl_bank_transactions', $bank_trans);
            }
            ...
            foreach($data->cart as $cartProduct){
                $saleDetails = array(
                    ...
                    'commission_percent' => $cartProduct->commission_percent,
    ...
    public function getSales(){
        ...
        $sales = $this->db->query("
            ...
            (
                ...
                FROM tbl_saledetails WHERE SaleMaster_IDNo = sm.SaleMaster_SlNo
