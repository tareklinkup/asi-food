...
// $route['AssetsEntry'] = 'Administrator/Assets';
// $route['get-assets'] = 'Administrator/Assets/getAssets';
// $route['insertassets'] = 'Administrator/Assets/insert_Assets';
// $route['update-asset'] = 'Administrator/Assets/updateAsset';
// $route['delete-asset'] = 'Administrator/Assets/deleteAsset';


// // assets account
// $route['asset'] = 'Administrator/Page/assetAccount';
// $route['get-asset-account'] = 'Administrator/Page/getAssetAccounts';
// $route['add-asset-account'] = 'Administrator/Page/saveAssetAccount';
// $route['update-asset-account'] = 'Administrator/Page/updateAssetAccount';
// $route['delete-asset-account'] = 'Administrator/Page/deletedAssetAccount';

// //asset item
// $route['asset-item'] = 'Administrator/Page/assetItem';
// $route['get-asset-item'] = 'Administrator/Page/getAssetItems';
// $route['add-asset-item'] = 'Administrator/Page/saveAssetItem';
// $route['update-asset-item'] = 'Administrator/Page/updateAssetItem';
// $route['delete-asset-item'] = 'Administrator/Page/deleteAssetItem';
...
$route['cash-transaction-invoice/(:num)'] = 'Administrator/Account/cashTransactionInvoice/$1';
...
//materials
$route['material-category'] = 'Administrator/MaterialCategory/materialCategory';
$route['get_material_categories'] = 'Administrator/MaterialCategory/getMaterialCategories';
$route['add_material_category'] = 'Administrator/MaterialCategory/addMaterialCategory';
$route['update_material_category'] = 'Administrator/MaterialCategory/updateMaterialCategory';
$route['delete_material_category'] = 'Administrator/MaterialCategory/deleteMaterialCategory';
